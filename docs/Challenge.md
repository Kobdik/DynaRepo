...
|общий расход	|постоянный расход|	пропорциональный |	относит. |	выборка   |	
|-------------|-----------------|------------------|----------|-----------|
|312          |	156             |	156              |	1.000	   |base1  4569|
|781	         | 156             |	625	             | 4.006	   |base4      |
|1 406	       | 156             |	1 250            |	8.013	   |base8      |
|2 656	       | 156             |	2 500	           | 16.026	  |base16     |
					
2 800	17.372		2.660		Отношение прямых скоростей
	2 710				
3 125	2 710	415	1.000	4 220	base 4569
4 375	2 710	1 665	4.012	16 880	base*4 5000
5 780	2 710	3 070	7.398	33760	base*8
9 530	2 710	6 820	16.434	67 520	base*16
